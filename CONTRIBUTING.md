...
You're using WebApp/Library and something doesn't appear to function the way
...
* Search the [issues
  list](https://github.com/webapp/library/issues)
...
* Provide unit tests in the correct location, ask if you need help finding it.
...
* Add documentation to the
  [Guides](https://github.com/webapp/library/tree/master/guide) if
  applicable.
* Release notes are added to the
  [readme.md](https://github.com/webapp/library/blob/master/README.md)
  if applicable.
