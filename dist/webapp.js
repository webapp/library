(function(window, factory) {
  ...
  if (typeof define === "function" && define.amd) {
    return define(["scopedcss", "underscore", "lodash", "jquery"], function() {
  ...
  // enviroments that support module.exports, like Node.
    ...
    module.exports = factory.call(window, require("scopedcss"), require("underscore"), require("lodash"), require("jquery"));
  }
...
var jQuery = window["jQuery"];
    ...
    var retVal = factory.call(window, ScopedCSS, _, _, jQuery);
  ...
  define.modules["scopedcss"] = arguments[0];
  
  define.modules["underscore"] = arguments[1];
  
  define.modules["lodash"] = arguments[2];
  
  define.modules["jquery"] = arguments[3];
