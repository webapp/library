(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.WebApp = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"./class":2,"./events":6,"./util/errors":17,"lodash":22}],2:[function(require,module,exports){
'use strict';
var Events = require('./events');
...
_.extend(Class.prototype, Events, { constructor: Class });
_.extend(Class, Inheritance);
module.exports = Class;
},{"./events":6,"./inheritance":9,"lodash":22}],3:[function(require,module,exports){
'use strict';
var Class = require('./class');
var Model = require('./model');
var Sync = require('./sync');
var wrapError = require('./util/wrap_error');
var urlError = require('./util/url_error');
var _ = require('lodash');
var setOptions = {
        add: true,
        remove: true,
...
},{"./class":2,"./model":10,"./sync":12,"./util/url_error":18,"./util/wrap_error":19,"lodash":22}],4:[function(require,module,exports){
'use strict';
...
Component.configure({ fetchTemplate: _.template });
Component.mixin({
    components: {},
    ...
    activate: function ($el, instances) {
        ...
        if (attrs.channels) {
            attrs.channel = Channel.create(attrs.channels);
        }
        attrs.el = $el;
        ...
        component.on('beforeRender', function () {
            _.keys(this.dataset).forEach(function (key) {
...
},{"./channel":1,"./view":20,"jquery":21,"lodash":22,"scopedcss":23}],5:[function(require,module,exports){
'use strict';
var Component = require('../component');
var ViewComponent = Component.extend({ selector: 'webapp-view' });
...
},{"./class":2,"jquery":21,"lodash":22}],8:[function(require,module,exports){
'use strict';
var Channel = require('./channel');
var Class = require('./class');
...
},{"./channel":1,"./class":2,"./collection":3,"./component":4,"./component/view":5,"./events":6,"./history":7,"./inheritance":9,"./model":10,"./router":11,"./sync":12,"./sync/transports/xhr":16,"./view":20,"jquery":21,"lodash":22,"scopedcss":23}],9:[function(require,module,exports){
'use strict';
var _ = require('lodash');
...
},{"./class":2,"./sync":12,"./util/url_error":18,"./util/wrap_error":19,"lodash":22}],11:[function(require,module,exports){
'use strict';
var Class = require('./class');
var optionalParam = /\((.*?)\)/g;
var namedParam = /(\(\?)?:\w+/g;
...
},{"./class":2}],12:[function(require,module,exports){
'use strict';
...
var Sync = function (method, model, options) {
    ...
    if (typeof Backbone !== 'undefined') {
        options.emulateHTTP = typeof options.emulateHTTP !== 'boolean' ? Backbone.emulateHTTP : options.emulateHTTP;
        options.emulateJSON = typeof options.emulateJSON !== 'boolean' ? Backbone.emulateJSON : options.emulateJSON;
    }
...
module.exports = Sync;
},{"./sync/adapters/rest":14,"./sync/transports/xhr":16,"lodash":22}],13:[function(require,module,exports){
'use strict';
var Class = require('../class');
var _ = require('lodash');
...
},{"../class":2,"lodash":22}],14:[function(require,module,exports){
'use strict';
...
},{"../class":2,"lodash":22}],16:[function(require,module,exports){
'use strict';
var Errors = require('../../util/errors');
...
var Xhr = Transport.extend({
        ...
        request: function (options) {
            ...
            options.adapter.create(options);
...
module.exports = Xhr;
},{"../../util/errors":17,"../transport":15,"jquery":21,"lodash":22}],17:[function(require,module,exports){
'use strict';
var _ = require('lodash');
...
(function (global){
'use strict';
window = typeof global === 'object' ? global : window;
var Class = require('./class');
var _ = require('lodash');
var $ = require('jquery');
...
var View = Class.extend({
        ...
        _viewRender: function (manager) {
            ...
            return {
                render: function () {
                    var context = _.result(root, 'scope');
...
},{"./class":2,"jquery":21,"lodash":22}],21:[function(require,module,exports){
/*!
