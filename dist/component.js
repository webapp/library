...
},{"./class":2,"./events":5,"./util/errors":13,"lodash":18}],2:[function(require,module,exports){
'use strict';
var Events = require('./events');
...
},{"./events":5,"./inheritance":6,"lodash":18}],3:[function(require,module,exports){
'use strict';
var Class = require('./class');
...
},{"./class":2,"./model":7,"./sync":8,"./util/url_error":14,"./util/wrap_error":15,"lodash":18}],4:[function(require,module,exports){
'use strict';
...
Component.mixin({
    ...
    register: function (Component, identifier) {
        ...
        if (cssText) {
            var scoped = new ScopedCss(identifier, cssText);
            document.body.appendChild(scoped.styleTag);
            scoped.process();
        }
...
},{"./channel":1,"./view":16,"jquery":17,"lodash":18,"scopedcss":19}],5:[function(require,module,exports){
'use strict';
var _ = require('lodash');
...
},{"./class":2,"./sync":8,"./util/url_error":14,"./util/wrap_error":15,"lodash":18}],8:[function(require,module,exports){
'use strict';
...
module.exports = Sync;
},{"./sync/adapters/rest":10,"./sync/transports/xhr":12,"lodash":18}],9:[function(require,module,exports){
'use strict';
var Class = require('../class');
var _ = require('lodash');
...
},{"../class":2,"lodash":18}],10:[function(require,module,exports){
'use strict';
...
module.exports = Rest;
},{"../adapter":9}],11:[function(require,module,exports){
'use strict';
var Class = require('../class');
var _ = require('lodash');
...
},{"../class":2,"lodash":18}],12:[function(require,module,exports){
'use strict';
var Errors = require('../../util/errors');
...
module.exports = Xhr;
},{"../../util/errors":13,"../transport":11,"jquery":17,"lodash":18}],13:[function(require,module,exports){
'use strict';
var _ = require('lodash');
        ...
        _render: function () {
            ...
            if (beforeRender) {
                ...
                if (ret && ret.then) {
                    ...
                    ret.then(def.resolve, def.resolve);
                }
                if (ret === false) {
                    return def.resolve();
                }
...
},{"./class":2,"./collection":3,"./model":7,"jquery":17,"underscore":20}],17:[function(require,module,exports){
/*!
