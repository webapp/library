define(function(require, exports, module) {
  ...
  var _isArray = require("lodash/objects/isArray");
  var _clone = require("lodash/objects/clone");
  var _isFunction = require("lodash/objects/isFunction");
  ...
  var _result = require("lodash/utilities/result");
  var _union = require("lodash/arrays/union");
  var _bind = require("lodash/functions/bind");
  var _isString = require("lodash/objects/isString");
  var _template = require("lodash/utilities/template");
  var _chain = require("lodash/chaining/chain");
  var _templateSettings = require("lodash/utilities/templateSettings");
  var _escape = require("lodash/utilities/escape");
  var _uniqueId = require("lodash/utilities/uniqueId");

  // jQuery methods.
  var $ = require("jquery/core");
  require("jquery/core/parseHTML");
    ...
    _viewRender: function(view) {
      ...
      return {
        ...
        render: function() {
          ...
          //_extend(view.observable, context);
